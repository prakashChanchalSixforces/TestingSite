                ...
                <Row xs={2} md={5} lg={5} className='d-flex justify-content-between'>
                    ...
                    <div>
                        ...
                        <ul className='list-unstyled'>
                            ...
                            Facebook</li>
                            <li className='mt-3 subheading' onClick={()=>window.open('http://instagram.com/swiftbel_official/','_blank')} ><img  alt='' src={instagram} /> &nbsp;Instagram</li>
                            <li className='mt-3 subheading' onClick={()=>window.open('https://www.linkedin.com/company/swiftbel','_blank')} ><img  alt='' src={linkedin} /> &nbsp;Linkedin</li>
                            <li className='mt-3 subheading' onClick={()=>window.open('http://www.twitter.com/swiftbel_HQ','_blank')} ><img  alt='' src={twitter} /> &nbsp;Twitter</li>
                        </ul>
                    </div>
                </Row>
                <br/>
