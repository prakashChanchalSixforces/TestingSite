...
import banner from '../../../../assets/TestingImg/budget.svg';
                            ...
                            <div >
                                ...
                                <div className='d-flex'>
                                    ...
                                    <p className='text2 pe-2'> <span style={{ fontSize: '32px' }}>40+ <br /></span>
                                        Years Combined Moving Experience</p>
                                    <p className='text2 pe-2'><span style={{ fontSize: '32px' }}>12+ <br /></span>
                                        Amazing Team Members</p>
                                </div>
                            </div>
                        </div>
                        <div>
