  ...
  const SizeOptions=['less than 1,000 ','1,000 to 1,500 ','1,500 to 2000 ','2,000 to 2,500 ','2,500 to 3000 ','3,000 to 3,500 ','Greater than 3,500 ']
    return (
        <React.Fragment>
            <Main >
                <div >
                    <p className='text1'>Never overpay when you book high-quality pressure washers on SwiftBel.</p>
                    <p className='text2'>Transparent pricing, fully-insured, and stress-free. Save an average of $55.</p>
