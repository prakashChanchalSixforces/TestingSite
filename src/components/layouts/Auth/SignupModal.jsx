...
const SignupModal = (props) => {
            ...
            <Col sm={11} xs={11} md={11} lg={11} style={{ margin: '0', padding: '0' }}>
              ...
              {emailFocus ? emailFocus && !validEmail ? (
                <div style={{ alignItems: 'center', flexDirection: 'row', display: 'flex' }}>
                  <img src={invalidCross} style={{ width: '15px', height: '15px', justifyContent: 'center', marginLeft: '22px', marginTop: '8px', marginRight: -10 }} className="oauthIcon " alt="logo" />
  ...
  return (
    <div>
      ...
      <MobileModal show={props?.show} onHide={() => props.signupModal(false)} placement={'bottom'} style={{ height: '650px' }}>
        <Offcanvas.Header closeButton={() => props.signupModal(false)}>
          <Offcanvas.Title>Log in or sign up</Offcanvas.Title>
        </Offcanvas.Header>
        {renderData()}
      </MobileModal>
